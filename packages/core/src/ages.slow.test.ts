 ...
 * the harness itself measures at — 24 runs x 500 years — the same 12,000 sampled campaign-years the old
 * 12 x 1000 instrument carried — rather than the demographic regression
