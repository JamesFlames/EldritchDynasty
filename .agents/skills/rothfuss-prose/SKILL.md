...
=======
>>>>>>> theirs
description: Write or revise plain, concrete event prose for Eldritch Dynasty.
---

# Event prose

Read and follow the complete canonical skill at
[`.claude/skills/rothfuss-prose/SKILL.md`](../../../.claude/skills/rothfuss-prose/SKILL.md).
<<<<<<< ours
>>>>>>> theirs
=======
>>>>>>> theirs
